...
public class TestaManager {
	public static void main(String[] args) throws Exception {
		...
		PC1 p11 = new PC1Normal("Koenigsegg", "Agera R", 6000, 600, p1, p1, 20); // 960cv
		PC1 p12 = new PC1Normal("SSC", "Tuatara", 6000, 800, p2, p2, 75); // 1350cv
		PC1 p13 = new PC1Normal("SSC", "Ultimate Aero TT", 6000, 1000, p3, p3, 100); // 1280cv
		PC1 p14 = new PC1Normal("Bugatti", "Veyron", 6000, 1200, p4, p4, 150); // 1200cv
		PC1 p15 = new PC1Normal("Venom", "GT", 6000, 1350, p5, p5, 200); // 1261cv
		
		PC1 p16 = new PC1Hibrido("Koenigsegg", "Agera R", 6000, 600, p1, p1, 0, 40); // 960cv
		PC1 p17 = new PC1Hibrido("SSC", "Tuatara", 6000, 800, p2, p2, 0, 75); // 1350cv
		PC1 p18 = new PC1Hibrido("SSC", "Ultimate Aero TT", 6000, 1000, p3, p3, 0, 100); // 1280cv
		PC1 p19 = new PC1Hibrido("Bugatti", "Veyron", 6000, 1200, p4, p4, 0, 150); // 1200cv
		PC1 p110 = new PC1Hibrido("Venom", "GT", 6000, 1350, p5, p5, 0, 200); // 1261cv
		...
		PC2 p26 = new PC2Hibrido("Ferrari Enzo", "", 4000, 450, p1, p1, 0, 40);
		PC2 p27 = new PC2Hibrido("As Ascari A10", "", 4500, 650, p2, p2, 0, 75);
		PC2 p28 = new PC2Hibrido("Aston Martin ", "", 5000, 700, p3, p3, 0, 100);
		PC2 p29 = new PC2Hibrido("Edonis", "", 5500, 850, p4, p4, 0, 150);
		PC2 p210 = new PC2Hibrido("Mercedes-Benz", "", 6000, 1000, p5, p5, 0, 200);
		...
		GT g6 = new GTHibrido("Peugeot 908 Equipe Peugeot", "", 3000, 200, p1, p1, 0, 40);
		GT g7 = new GTHibrido("Ferrari F10", "", 3400, 350, p2, p2, 0, 95);
		GT g8 = new GTHibrido("Mazda 787B Race Car", "", 3800, 500, p3, p3, 0,130);
		GT g9 = new GTHibrido("Red Bull X2010 S.Vettel", "", 4100, 600, p4, p4, 0,180);
		GT g10 = new GTHibrido("Hennessey Venom GT", "", 4500, 750, p5, p5, 0,210);
